...
2. 御朱印登録ページから、神社・お寺の名前、参拝日、種類、写真、メモ、参拝場所を入力します。
3. 地図をクリックすると、参拝場所を位置情報として登録できます。
4. 登録ボタンを押すと、御朱印の記録が保存されます。
5. 登録した御朱印の数に応じて、ユーザーのレベルが上がります。
...
4. 所持スタンプ一覧ページで、自分が持っているスタンプを確認できます。
